<?php
/**
 * BaloaStructureAuditorSEO\Core\Hooks
...
class Hooks {
    ...
    // â”€â”€ Analysis Hooks â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    public static function filter_html( string $html, string $url ): string {
        return apply_filters( 'baloa_structure_auditor_seo_filter_html', $html, $url );
    }
    ...
    public static function filter_results( array $results, string $url ): array {
        return apply_filters( 'baloa_structure_auditor_seo_filter_results', $results, $url );
    }
    ...
    public static function action_after_analysis( array $results, string $url ): void {
        do_action( 'baloa_structure_auditor_seo_after_analysis', $results, $url );
    }
    ...
    public static function filter_global_score( int $score, array $results ): int {
        return apply_filters( 'baloa_structure_auditor_seo_filter_global_score', $score, $results );
    }

    // â”€â”€ Module Hooks â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    public static function filter_analyzers( array $modules ): array {
        return apply_filters( 'baloa_structure_auditor_seo_filter_analyzers', $modules );
    }
    ...
    public static function filter_module_result( array $module_results, string $module_name, string $url ): array {
        return apply_filters( 'baloa_structure_auditor_seo_filter_module_result', $module_results, $module_name, $url );
    }

    // â”€â”€ Fetching Hooks â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    public static function filter_fetch_args( array $args, string $url ): array {
        return apply_filters( 'baloa_structure_auditor_seo_filter_fetch_args', $args, $url );
    }
    ...
    public static function filter_fetched_html( string $html, string $url ): string {
        return apply_filters( 'baloa_structure_auditor_seo_filter_fetched_html', $html, $url );
    }

    // â”€â”€ Batch Hooks â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    public static function action_batch_created( string $job_id, array $urls, string $keyword ): void {
        do_action( 'baloa_structure_auditor_seo_batch_created', $job_id, $urls, $keyword );
    }
    ...
    public static function action_batch_completed( string $job_id, array $job ): void {
        do_action( 'baloa_structure_auditor_seo_batch_completed', $job_id, $job );
    }
    ...
    public static function action_batch_url_analyzed( string $job_id, string $url, array $result ): void {
        do_action( 'baloa_structure_auditor_seo_batch_url_analyzed', $job_id, $url, $result );
    }

    // â”€â”€ Report Hooks â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    public static function filter_report_html( string $html, array $results, string $url ): string {
        return apply_filters( 'baloa_structure_auditor_seo_filter_report_html', $html, $results, $url );
    }
    ...
    public static function filter_report_filename( string $filename, array $results, string $url ): string {
        return apply_filters( 'baloa_structure_auditor_seo_filter_report_filename', $filename, $results, $url );
    }
}
